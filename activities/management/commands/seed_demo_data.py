...
class Command(BaseCommand):
    help = "Create demo companies, coaches, and future activities for local development."
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(
            self.style.SUCCESS(
                f"Demo data ready: {Activity.objects.count()} activities available ({created_count} created)."
            )
        )
